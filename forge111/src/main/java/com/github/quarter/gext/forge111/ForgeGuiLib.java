...
package com.github.quarter.gext.forge111;

import com.github.quarter.gext.GuiLib;
import com.github.quarter.gext.forge111.adapter.MinecraftResourceManager;
...
@Mod(modid = ForgeGuiLib.MODID, name = ForgeGuiLib.NAME, version = ForgeGuiLib.VERSION, clientSideOnly = true, acceptedMinecraftVersions = "1.11.2")
