...
package com.github.stannismod.gext.forge119.adapter;

import com.github.stannismod.gext.api.adapter.IFontRenderer;
import com.github.stannismod.gext.forge119.ForgeGExt;
...
public class MinecraftFontRenderer implements IFontRenderer {
    ...
    private final Font instance;

    public MinecraftFontRenderer(Font instance) {
