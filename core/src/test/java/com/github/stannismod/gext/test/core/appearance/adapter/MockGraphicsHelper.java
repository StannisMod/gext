...
public class MockGraphicsHelper implements IGraphicsHelper {

    public static final MockGraphicsHelper INSTANCE = new MockGraphicsHelper();

    private MockGraphicsHelper() {}
