...
package com.github.quarter.gext.utils;
 ...
 * {@link #create()} to work.
 * @param <SELF> the pointer to the end implementation. By default, declared in {@link com.github.quarter.gext.components.Graphics}
 * @param <T> the pointer to the target type that should be built. By default, declared in {@link com.github.quarter.gext.components.Graphics}
 * @since 1.3
 */
